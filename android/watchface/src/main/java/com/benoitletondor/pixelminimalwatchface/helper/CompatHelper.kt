...
import com.benoitletondor.pixelminimalwatchface.ComplicationProvider
...
private fun ComplicationProvider.isSamsungHealthBadComplicationData(context: Context): Boolean {
...
private fun ComplicationProvider.isSamsungDailyActivityBuggyProvider(): Boolean {
    return when(this) {
        is ComplicationProvider.AppName -> appName in samsungHealthAppNames && providerName in dailyActivityProviderNames
        is ComplicationProvider.Component -> component.packageName == S_HEALTH_PACKAGE_NAME &&
            component.className == "com.samsung.android.wear.shealth.complications.dailyactivity.DailyActivityComplicationProviderService"
    }
}

fun ComplicationProvider.isSamsungCalendarBuggyProvider(): Boolean {
    if (!isGalaxyWatch4CalendarBuggyWearOSVersion) {
        return false
    }

    return when(this) {
        is ComplicationProvider.AppName -> appName in oneUIWatchHomeAppNames && providerName in calendarProviderNames
        is ComplicationProvider.Component -> component.packageName == S_CALENDAR_PACKAGE_NAME &&
            component.className == "com.google.android.clockwork.sysui.experiences.calendar.NextEventProviderService"
    }
}

private fun ComplicationProvider.isSamsungStepsProvider(): Boolean {
    return when(this) {
        is ComplicationProvider.AppName -> appName in samsungHealthAppNames && providerName in stepsProviderNames
        is ComplicationProvider.Component -> component.packageName == S_HEALTH_PACKAGE_NAME &&
            component.className == "com.samsung.android.wear.shealth.complications.steps.StepsComplicationProviderService"
    }
}

private fun ComplicationProvider.isSamsungSleepProvider(): Boolean {
    return when(this) {
        is ComplicationProvider.AppName -> appName in samsungHealthAppNames && providerName in sleepProviderNames
        is ComplicationProvider.Component -> component.packageName == S_HEALTH_PACKAGE_NAME &&
            component.className == "com.samsung.android.wear.shealth.complications.sleep.SleepComplicationProviderService"
    }
}

private fun ComplicationProvider.isSamsungWaterSleepProvider(): Boolean {
    return when(this) {
        is ComplicationProvider.AppName -> appName in samsungHealthAppNames && providerName in waterProviderNames
        is ComplicationProvider.Component -> component.packageName == S_HEALTH_PACKAGE_NAME &&
            component.className == "com.samsung.android.wear.shealth.complications.water.WaterComplicationProviderService"
    }
}

fun ComplicationProvider.isSamsungHeartRateProvider(): Boolean {
    return when(this) {
        is ComplicationProvider.AppName -> appName in samsungHealthAppNames && providerName in heartRateProviderNames
        is ComplicationProvider.Component -> component.packageName == S_HEALTH_PACKAGE_NAME &&
            component.className == "com.samsung.android.wear.shealth.complications.heartrate.HeartrateComplicationProviderService"
    }
}
