...
/*
 * Copy paste of TextRenderer with one change:
 *
 * Replace: paint.setTextSize(Math.min(height / mMaxLines, paint.getTextSize()));
 * With: paint.setTextSize(mPaint.getTextSize());
 */
