...
import androidx.wear.watchface.complications.rendering.custom.CustomComplicationDrawableHelper
...
class CustomComplicationDrawable : Drawable {
    ...
    public fun setContext(context: Context) {
        ...
        complicationRenderer = CustomComplicationRenderer(this.context, activeStyle, ambientStyle)
    ...
    public fun setComplicationData(
        ...
        if (loadDrawablesAsync) {
            ...
            // has completed.
            val nextRenderer = CustomComplicationRenderer(this.context, activeStyle, ambientStyle)
    ...
    internal fun updateStyleIfRequired() {
        if (CustomComplicationDrawableHelper.isStyleDirty(activeStyle) || CustomComplicationDrawableHelper.isStyleDirty(ambientStyle)) {
            complicationRenderer!!.updateStyle(activeStyle, ambientStyle)
            CustomComplicationDrawableHelper.clearDirtyFlag(activeStyle)
            CustomComplicationDrawableHelper.clearDirtyFlag(ambientStyle)
        }
    }
